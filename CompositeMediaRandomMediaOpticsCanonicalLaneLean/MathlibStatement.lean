...
Composite Media endgame pilot. The pilot closes over its admitted class and carries the
...
def theoremSpecificEndgamePilotClosed : Prop :=
  forall A : AdmissibleClass, ConstrainedCompositeMediaClosure A

theorem theorem_specific_endgame_pilot_checked :
    theoremSpecificEndgamePilotClosed := by
  intro A
  exact constrained_composite_media_endgame A
