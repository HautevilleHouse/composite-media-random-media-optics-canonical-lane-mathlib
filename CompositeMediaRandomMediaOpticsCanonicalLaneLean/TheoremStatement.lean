import CompositeMediaRandomMediaOpticsCanonicalLaneLean.ReviewerBridge

/-!
# Theorem Statement Layer

This module internalizes the theorem-facing object for `composite-media-random-media-optics-canonical-lane`
